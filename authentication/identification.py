...
if __name__ == "__main__":
    ...
    if args.mode == 0:
        ...
        # train_noisy_dataset = MyDataSet('speaker_embedding/noise_DNN_embedding', ratio=0.8)
        # test_noisy_dataset = MyDataSet('speaker_embedding/noise_DNN_embedding', ratio=-0.2)
        # train_dataset = ConcatDataset([train_noisy_dataset, train_dataset])
        # test_dataset = ConcatDataset([test_noisy_dataset, test_dataset])
