...
if __name__ == "__main__":
    ...
    if args.mode == 0:
        ...
        for p in people:
            dataset = NoisyCleanSet(['json/train_gt.json', 'json/all_noise.json',  'json/train_imu1.json', 'json/train_imu2.json'], person=[p],
                                    simulation=True)
        ...
        for noise in ['background.json', 'dev.json', 'music.json']:
            dataset = NoisyCleanSet(['json/train_gt.json', 'json/' + noise,  'json/train_imu1.json', 'json/train_imu2.json'], person=people,
                                    simulation=True)
            Metric = inference(dataset, BATCH_SIZE, model, audio_only=False, complex=False)
            avg_metric = np.mean(Metric, axis=0)
        ...
        for level in [11, 6, 1]:
            dataset = NoisyCleanSet(['json/train_gt.json', 'json/all_noise.json',  'json/train_imu1.json', 'json/train_imu2.json'], person=people,
