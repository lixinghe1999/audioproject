...
class ASTModel(nn.Module):
    ...
    """
    def __init__(self, label_dim=309, fstride=10, tstride=10, input_fdim=128, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384', verbose=True):
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            sd = torch.load('assets/audioset_0.4593.pth')
