...
class ASTModel(nn.Module):
    ...
    """
    def  __init__(self, label_dim=309, fstride=16, tstride=16, input_fdim=128, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384', verbose=True):
